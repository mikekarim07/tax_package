...
if file is not None:
    ...
    merged_FBL3N_classified = merged_FBL3N_classified[(FBL3N_classified['Company Code'].isin(company_codes)]) and (merged_FBL3N_classified['Related Party'].isin(related_parties)]
