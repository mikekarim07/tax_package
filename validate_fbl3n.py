...
if file is not None:
    ...
    merged_FBL3N_classified = FBL3N_classified.merge(FBL3N_classified, left_on="Key_1", right_on='Key_2', how='outer', suffixes=('_sell', '_purchase'))
    # merged_FBL3N_classified = merged_FBL3N_classified[(merged_FBL3N_classified['Company Code_sell'].isin(company_codes)) & (merged_FBL3N_classified['Company Code_purchase'].isin(related_parties))]
