...
@st.cache
def load_and_process_data(uploaded_FBL3N_train, uploaded_new_FBL3N, uploaded_masters):
...
uploaded_new_FBL3N = st.sidebar.file_uploader("Upload new FBL3N file...", type=["xlsx"], accept_multiple_files=False)
uploaded_masters = st.sidebar.file_uploader("Upload masters file...", type=["xlsx"], accept_multiple_files=False)

# Check if all files are uploaded
if uploaded_FBL3N_train and uploaded_new_FBL3N and uploaded_masters:
    # Call the function to load and process the data
    FBL3N_Classified = load_and_process_data(uploaded_FBL3N_train, uploaded_new_FBL3N, uploaded_masters)
