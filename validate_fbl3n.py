...
if file is not None:
    ...
    merged_FBL3N_classified = FBL3N_classified[(FBL3N_classified['Company Code sell'].isin(company_code_filter)) & (FBL3N_classified['Company Code purchase'].isin(related_party_filter))]
