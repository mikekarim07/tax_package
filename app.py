...
if uploaded_FBL3N_train and uploaded_new_FBL3N and uploaded_masters: #and uploaded_ZLAAUDIT:
    ...
    ZLAAUDIT_grouped = ZLAAUDIT_filtrado.groupby(by=['Company Code', 'Document Number', 'Account', 'Posting Key', 'Currency', 'Local Currency'], as_index=False).agg({'Amount in foreign cur.': 'sum','Debit/credit amount': 'sum'})
