...
if uploaded_FBL3N_train:
    ...
    FBL3N_full['Identificador'] = FBL3N_full['Company Code'] + ' ' + FBL3N_full['Document Type'] + ' ' +  FBL3N_full['Document Number'] + ' ' + (FBL3N_full['Amount in doc. curr.'].astype(str)) + ' ' + FBL3N_full['Posting Date']
    # st.divider()
